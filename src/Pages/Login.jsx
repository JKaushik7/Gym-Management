      ...
      <section className="login-section">
        ...
        <div className="page-padding py-[10rem] flex justify-center">
          <form
            ...
            <label className="text-[2rem] text-white mb-3 font-medium outline-[#ff0336] outline-2">Password</label>
            <input
              className="text-[1.7rem] px-8 py-4 mb-10 w-full outline-[#ff0336] "
            ...
            <button type="submit" className="bg-[#ff0336] text-white py-4 font-medium text-[2rem] w-full mt-10">Sign In</button>
